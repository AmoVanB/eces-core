 ...
 */
public class S4 extends RootSystem {
	public int count  = 0;
	public int count2 = 0;
	public int count3 = 0;
	public int count4 = 0;
	...
	public S4(Controller controller) {
		super(controller);
	}
	...
	@ComponentStateIs(State = ComponentStatus.Any)
	public void triggerWarningBecauseNoArg() {
	}

	@ComponentStateIs(State = ComponentStatus.Any)
	public void triggerWarningBecauseNoArg(Integer i) {
	}
}